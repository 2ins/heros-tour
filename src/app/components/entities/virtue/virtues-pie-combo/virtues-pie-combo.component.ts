...
@Component({
  selector: 'app-virtues-pie-combo',
  templateUrl: './virtues-pie-combo.component.html',
  styleUrls: ['./virtues-pie-combo.component.css'],
})
export class VirtuesPieComboComponent implements OnInit {
