...
@Component({
  selector: 'app-qualities-list-vertical-big',
  templateUrl: './qualities-list-vertical-big.component.html',
  styleUrls: ['./qualities-list-vertical-big.component.css'],
})
export class QualitiesListVerticalBigComponent implements OnInit {
  @Input()
  qualities?: Quality[] = [];
